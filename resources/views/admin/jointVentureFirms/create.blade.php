...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.jointVentureFirm.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.joint-venture-firms.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('firm_name') ? 'is-invalid' : '' }}" type="text" name="firm_name" id="firm_name" value="{{ old('firm_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('firm_code') ? 'is-invalid' : '' }}" type="text" name="firm_code" id="firm_code" value="{{ old('firm_code', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contract_person') ? 'is-invalid' : '' }}" type="text" name="contract_person" id="contract_person" value="{{ old('contract_person', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('joint_venture_nature') ? 'is-invalid' : '' }}" name="joint_venture_nature" id="joint_venture_nature">{!! old('joint_venture_nature') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('leading_firm_name') ? 'is-invalid' : '' }}" type="text" name="leading_firm_name" id="leading_firm_name" value="{{ old('leading_firm_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('share_value') ? 'is-invalid' : '' }}" type="text" name="share_value" id="share_value" value="{{ old('share_value', '') }}">
