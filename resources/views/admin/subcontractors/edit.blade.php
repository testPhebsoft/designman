...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.subcontractor.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.subcontractors.update", [$subcontractor->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.subcontractor.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $subcontractor->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" type="text" name="code" id="code" value="{{ old('code', $subcontractor->code) }}" required>
                @if($errors->has('code'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address">{{ old('address', $subcontractor->address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contract_person') ? 'is-invalid' : '' }}" type="text" name="contract_person" id="contract_person" value="{{ old('contract_person', $subcontractor->contract_person) }}" required>
            ...
            <!-- <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $subcontractor->start_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $subcontractor->end_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('assignment_value') ? 'is-invalid' : '' }}" type="text" name="assignment_value" id="assignment_value" value="{{ old('assignment_value', $subcontractor->assignment_value) }}">
