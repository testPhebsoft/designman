    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employee_code') ? 'is-invalid' : '' }}" type="text" name="employee_code" id="employee_code" value="{{ old('employee_code', $user->employee_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('father_name') ? 'is-invalid' : '' }}" type="text" name="father_name" id="father_name" value="{{ old('father_name', $user->father_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('joining_date') ? 'is-invalid' : '' }}" type="text" name="joining_date" id="joining_date" value="{{ old('joining_date', $user->joining_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_number') ? 'is-invalid' : '' }}" type="text" name="contact_number" id="contact_number" value="{{ old('contact_number', $user->contact_number) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('residence_address') ? 'is-invalid' : '' }}" name="residence_address" id="residence_address">{{ old('residence_address', $user->residence_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cnic') ? 'is-invalid' : '' }}" type="text" name="cnic" id="cnic" value="{{ old('cnic', $user->cnic) }}">
                @if($errors->has('cnic'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('citizenship') ? 'is-invalid' : '' }}" type="text" name="citizenship" id="citizenship" value="{{ old('citizenship', $user->citizenship) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('disability') ? 'is-invalid' : '' }}" type="text" name="disability" id="disability" value="{{ old('disability', $user->disability) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blood_group') ? 'is-invalid' : '' }}" type="text" name="blood_group" id="blood_group" value="{{ old('blood_group', $user->blood_group) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('job_status') ? 'is-invalid' : '' }}" name="job_status" id="job_status">
                    ...
                    @foreach(App\Models\User::JOB_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('job_status', $user->job_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code_membership_professional') ? 'is-invalid' : '' }}" type="text" name="code_membership_professional" id="code_membership_professional" value="{{ old('code_membership_professional', $user->code_membership_professional) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_title') ? 'is-invalid' : '' }}" type="text" name="account_title" id="account_title" value="{{ old('account_title', $user->account_title) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_num') ? 'is-invalid' : '' }}" type="text" name="account_num" id="account_num" value="{{ old('account_num', $user->account_num) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_name') ? 'is-invalid' : '' }}" type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $user->bank_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_branch') ? 'is-invalid' : '' }}" type="text" name="bank_branch" id="bank_branch" value="{{ old('bank_branch', $user->bank_branch) }}">
