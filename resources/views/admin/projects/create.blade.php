    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_code') ? 'is-invalid' : '' }}" type="text" name="project_code" id="project_code" value="{{ old('project_code', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('project_nature') ? 'is-invalid' : '' }}" name="project_nature" id="project_nature">{!! old('project_nature') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('project_scope') ? 'is-invalid' : '' }}" name="project_scope" id="project_scope">{!! old('project_scope') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('estimated_cost') ? 'is-invalid' : '' }}" type="text" name="estimated_cost" id="estimated_cost" value="{{ old('estimated_cost', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('estimated_duration') ? 'is-invalid' : '' }}" type="text" name="estimated_duration" id="estimated_duration" value="{{ old('estimated_duration', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_head') ? 'is-invalid' : '' }}" name="project_head_id" id="project_head_id">
                    @foreach($project_heads as $id => $entry)
                        <option value="{{ $id }}" {{ old('project_head_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('handled_as') ? 'is-invalid' : '' }}" name="handled_as" id="handled_as" required>
                    ...
                    @foreach(App\Models\Project::HANDLED_AS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('handled_as', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('implementation_date') ? 'is-invalid' : '' }}" type="text" name="implementation_date" id="implementation_date" value="{{ old('implementation_date') }}">
