    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.departments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('department_code') ? 'is-invalid' : '' }}" type="text" name="department_code" id="department_code" value="{{ old('department_code', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('roles_responsibilities') ? 'is-invalid' : '' }}" name="roles_responsibilities" id="roles_responsibilities">{!! old('roles_responsibilities') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('department_assets') ? 'is-invalid' : '' }}" name="department_assets" id="department_assets">{{ old('department_assets') }}</textarea>
