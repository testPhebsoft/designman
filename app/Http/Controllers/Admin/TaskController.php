...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        $tasks = Task::with(['status', 'tags', 'assigned_to', 'milestone', 'media'])->get();
    ...
    public function create()
    {
        ...
        $milestones = Milestone::pluck('title', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.tasks.create', compact('assigned_tos', 'milestones', 'statuses', 'tags'));
    }
    ...
    public function edit(Task $task)
    {
        ...
        $task->load('status', 'tags', 'assigned_to', 'milestone');

        return view('admin.tasks.edit', compact('assigned_tos', 'milestones', 'statuses', 'tags', 'task'));
    }
